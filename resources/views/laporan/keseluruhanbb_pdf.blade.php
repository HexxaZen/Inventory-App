...
<head>
    <meta charset="UTF-8">
    <title>Laporan Bahan Baku Keseluruhan - Merra Inventory</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <div class="title">Laporan Bahan Baku Keseluruhan</div>
        ...
        <tbody>
            @forelse ($laporan as $data)
                <tr>
                    ...
                    <td class="text-right">{{ $data->stok_terakhir }}</td>
                    <td class="text-right">{{ $data->sisa_stok }}</td>
                    <td class="text-center">
                        {{ \Carbon\Carbon::parse($data->tanggal_terakhir)->format('d-m-Y') }}
                    </td>
                </tr>
            @empty
                <tr>
