    ...
    <div class="sidebar-logo">
        <div class="logo-header" data-background-color="dark" style="background-color: #3a3a3a;">
            <a href="{{ route('dashboard') }}" class="logo">
                <img src="{{ asset('admin/assets/img/kaiadmin/favicon.png') }}" alt="Merra's Logo" class="navbar-brand"
                    height="70" style="padding-top:10px;" />
            </a>
                    ...
                    <div class="collapse {{ Request::routeIs('bahan.*') ? 'show' : '' }}" id="bahan">
                        <ul class="nav nav-collapse">
                            <li><a href="{{ route('bahan.index') }}"
                                    class="{{ Request::routeIs('bahan.index') ? 'active' : '' }}"><span
                                        class="sub-item">Bahan Baku</span></a></li>
                            ...
                            <li><a href="{{ route('bahan.bahanakhir') }}"
                                    class="{{ Request::routeIs('bahan.bahanakhir') ? 'active' : '' }}"><span
                                        class="sub-item">Bahan Akhir</span></a></li>
                            <li><a href="{{ route('bahan.bahankeluar') }}"
                                    class="{{ Request::routeIs('bahan.bahankeluar') ? 'active' : '' }}"><span
                ...
                @if (auth()->user()->hasRole('Admin') || auth()->user()->hasRole('Headbar') || auth()->user()->hasRole('Headkitchen'))
                    <li class="nav-item {{ Request::routeIs('laporan.*') ? 'active' : '' }}">
                        ...
                        <div class="collapse {{ Request::routeIs('laporan.*') ? 'show' : '' }}" id="laporan">
                            <ul class="nav nav-collapse">
                                <li><a
                                        href="{{ route('laporan.pemantauan') }}"class="{{ Request::routeIs('laporan.pemantauan') ? 'active' : '' }}"><span
                                            class="sub-item">PEMANTAUAN BAHAN BAKU</span></a></li>
                                <li><a href="{{ route('laporan.bahan') }}"
                                        class="{{ Request::routeIs('laporan.bahan') ? 'active' : '' }}"><span
                                            class="sub-item">Bahan Baku</span></a></li>
