...
<body>
    ...
    <section id="home" class="hero-wrap js-fullheight"
        style="background-image: url({{ asset('landingpage/images/homebg.jpg') }});" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
                <div class="col-lg-7 ftco-animate d-flex align-items-center">
                    <div class="text text-center">
                        <a href="index.html"><img src="{{ asset('landingpage/images/logomerra.png')}}" alt="Logo Merra" width="500ch" style="margin-bottom: 50px;"></a>
                        <h1 class="mb-4">We Make <br>Something Great for You</h1>
                        <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis similique eius placeat ut tempore recusandae praesentium nesciunt. Beatae dolorum libero voluptate magnam deleniti. Mollitia cumque quisquam neque officia officiis optio.</p>
                        <p class="mt-5"><a href="{{route('login')}}" class="btn-custom">Staff's Login <span
                ...
                <div class="col-md-6 col-lg-6 d-flex">
                    <div class="img-about img d-flex align-items-stretch">
                        ...
                        <div class="img img-video d-flex align-self-stretch align-items-center"
                            style="background-image:url({{ asset('landingpage/images/about-2.jpg') }});">
                    ...
                    <div class="heading-section ftco-animate">
                        ...
                        <div class="d-flex w-100">
                            <div class="img img-about-2 mr-2"
                                style="background-image: url({{ asset('landingpage/images/about.jpg') }});"></div>
                            <div class="img img-about-2 ml-2"
                                style="background-image: url({{ asset('landingpage/images/about-3.jpg') }});"></div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row progress-circle pt-md-5">
                ...
                <div class="col-md-5 d-flex align-items-stretch">
                    <div class="img w-100"
                        style="background-image: url({{ asset('landingpage/images/about-2.jpg') }});"></div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row no-gutters">
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-1.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-1.jpg') }}"
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-2.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-2.jpg') }}"
                            class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="icon-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-3.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-3.jpg') }}"
                            class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="icon-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-4.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-4.jpg') }}"
                            class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="icon-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-5.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-5.jpg') }}"
                            class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="icon-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-6.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-6.jpg') }}"
                            class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="icon-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-7.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-7.jpg') }}"
                            class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="icon-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-8.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-8.jpg') }}"
                            class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="icon-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-9.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-9.jpg') }}"
                            class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="icon-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-10.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-10.jpg') }}"
                            class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="icon-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-11.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-11.jpg') }}"
                            class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="icon-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="model img d-flex align-items-end"
                        style="background-image: url({{ asset('landingpage/images/model-12.jpg') }});">
                        <a href="{{ asset('landingpage/images/model-12.jpg') }}"
                            class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="icon-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
