...
<div class="container mt-4">
    ...
    <!-- Form Input Tanggal (Sesuai Sistem) -->
    <form action="{{ route('bahan.akhir.tanggal') }}" method="POST" class="mb-4">
        @csrf
        <div class="row justify-content-center">
            <div class="col-md-6">
                <label for="tanggal">Tanggal Input (Otomatis):</label>
                <input type="date" id="tanggal" name="tanggal_input" class="form-control" 
            ...
            <div class="table-responsive mt-3">
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><input type="text" class="form-control-plaintext text-center" value="{{ $item->kode_bahan }}" readonly></td>
                            <td><input type="text" class="form-control-plaintext text-center" value="{{ $item->nama_bahan }}" readonly></td>
                            <td><input type="text" class="form-control-plaintext text-center" value="{{ $item->kategori_bahan }}" readonly></td>
                            <td>
                                <input type="number" class="form-control stok-input text-center" 
                                       name="sisa_stok[{{ $item->id }}]" 
                                       value="{{ old('sisa_stok.' . $item->id, $item->sisa_stok) }}" 
                                       min="0" required>
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="text-center">Tidak ada bahan yang didata untuk tanggal ini.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
